...
public final class Participant implements IFilterable {
  ...
  public String toString() {
    return String.valueOf(Text.PARTICIPANT) + " [" + Text.PARTICIPANT_ID + "=" + id + ", " + Text.PARTICIPANT_LASTNAME
           + "=" + lastName + ", " + Text.PARTICIPANT_FORENAME + "=" + foreName + ", " + Text.PARTICIPANT_GENDER + "="
           + gender + ", " + Text.PARTICIPANT_DENOMINATION + "=" + denomination + ", " + Text.PARTICIPANT_BIRTHDAY + "="
           + birthDate + ", " + Text.PARTICIPANT_ADDRESS_LIVING + "=" + livingAddress + ", "
           + Text.PARTICIPANT_ADDRESS_POSTAL + "=" + postToAddress + ", " + Text.PARTICIPANT_PHONE + "=" + phone + ", "
           + Text.PARTICIPANT_FAX + "=" + fax + ", " + Text.PARTICIPANT_MOBILE_PHONE + "=" + mobilePhone + ", "
           ...
           + Text.PARTICIPANT_BANK_CODE_NUMBER + "=" + bankCodeNumber + ", " + Text.PARTICIPANT_BANK_NAME + "=" + bank
           + ", " + Text.PARTICIPANT_BANK_ACCOUNT_NUMBER + "=" + bankAccountNumber + ", " + Text.PARTICIPANT_COMMENT
           + "=" + comment + ", " + Text.PARTICIPANT_DATE_SINCE + "=" + dateSinceInDataBase + ", "
           + Text.PARTICIPANT_DATE_UNTIL + "=" + dateUpToInSystem + "]";
  }
}
