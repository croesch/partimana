 ...
 */
public final class CountyCouncilCategory extends ACategory<CampParticipant, CountyCouncil> {
  ...
  @Override
  protected CountyCouncil getValue(final CampParticipant element) {
