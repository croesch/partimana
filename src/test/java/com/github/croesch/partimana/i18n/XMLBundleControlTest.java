...
public class XMLBundleControlTest {
   ...
   */
  @Test(expected = IllegalArgumentException.class)
  public void testNewBundleStringLocaleStringClassLoaderBoolean_IAE1()
   ...
   */
  @Test(expected = IllegalArgumentException.class)
  public void testNewBundleStringLocaleStringClassLoaderBoolean_IAE2()
      throws IllegalAccessException, InstantiationException, IOException {
    final XMLBundleControl control = new XMLBundleControl();
   ...
   */
  @Test(expected = IllegalArgumentException.class)
  public void testNewBundleStringLocaleStringClassLoaderBoolean_IAE3()
      throws IllegalAccessException, InstantiationException, IOException {
    final XMLBundleControl control = new XMLBundleControl();
   ...
   */
  @Test(expected = IllegalArgumentException.class)
  public void testNewBundleStringLocaleStringClassLoaderBoolean_IAE4()
      throws IllegalAccessException, InstantiationException, IOException {
    final XMLBundleControl control = new XMLBundleControl();
   ...
   */
  @Test
  public void testNewBundleStringLocaleStringClassLoaderBoolean_Null1()
      throws IllegalAccessException, InstantiationException, IOException {
    final XMLBundleControl control = new XMLBundleControl();
   ...
   */
  @Test
  public void testNewBundleStringLocaleStringClassLoaderBoolean_Null2()
      throws IllegalAccessException, InstantiationException, IOException {
    final XMLBundleControl control = new XMLBundleControl();
    assertThat(control.newBundle("baseName", Locale.getDefault(), "xml", ClassLoader.getSystemClassLoader(), true))
        .isNull();
