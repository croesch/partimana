...
/**
 * Provides test cases for {@link CanBeMAKCategory}.
 * 
 * @author croesch
 * @since Date: Oct 27, 2012
 */
public class CanBeMAKCategoryTest {

  private CanBeMAKCategory category;

  @org.junit.Before
  public void setUp() {
    this.category = new CanBeMAKCategory();
  }
  ...
  public void testGetShortDescription() {
    assertThat(this.category.getShortDescription()).isEqualTo(Text.FILTER_CAT_PARTICIPANT_CAN_BE_MAK.text());
    assertThat(this.category.getShortDescription()).isEqualTo(Text.PARTICIPANT_MAK.text());
  }
  ...
  public void testEquals() {
    assertThat(this.category).isEqualTo(new CanBeMAKCategory());
    ...
    this.category.setFilter(new BooleanEquals());
    final CanBeMAKCategory other = new CanBeMAKCategory();
  ...
  public void testHashCode() {
    assertThat(this.category.hashCode()).isEqualTo(new CanBeMAKCategory().hashCode());
