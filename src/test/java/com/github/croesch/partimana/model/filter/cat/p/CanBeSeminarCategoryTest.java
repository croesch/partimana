...
/**
 * Provides test cases for {@link CanBeSeminarCategory}.
 * 
 * @author croesch
 * @since Date: Oct 27, 2012
 */
public class CanBeSeminarCategoryTest {

  private CanBeSeminarCategory category;

  @org.junit.Before
  public void setUp() {
    this.category = new CanBeSeminarCategory();
  }
  ...
  public void testGetShortDescription() {
    assertThat(this.category.getShortDescription()).isEqualTo(Text.FILTER_CAT_PARTICIPANT_CAN_BE_SEMINAR.text());
    assertThat(this.category.getShortDescription()).isEqualTo(Text.PARTICIPANT_SEMINAR.text());
  }
  ...
  public void testEquals() {
    ...
    this.category.setFilter(new BooleanEquals());
    final CanBeSeminarCategory other = new CanBeSeminarCategory();
  ...
  public void testHashCode() {
    assertThat(this.category.hashCode()).isEqualTo(new CanBeSeminarCategory().hashCode());
