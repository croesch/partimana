...
/**
 * Provides test cases for {@link CanBeKitchenCategory}.
 * 
 * @author croesch
 * @since Date: Oct 27, 2012
 */
public class CanBeKitchenCategoryTest {

  private CanBeKitchenCategory category;

  @org.junit.Before
  public void setUp() {
    this.category = new CanBeKitchenCategory();
  }
  ...
  public void testGetShortDescription() {
    assertThat(this.category.getShortDescription()).isEqualTo(Text.FILTER_CAT_PARTICIPANT_CAN_BE_KITCHEN.text());
    assertThat(this.category.getShortDescription()).isEqualTo(Text.PARTICIPANT_CAMP_KITCHEN.text());
  }
  ...
  public void testEquals() {
    assertThat(this.category).isEqualTo(new CanBeKitchenCategory());
    ...
    this.category.setFilter(new Equals<Boolean>());
    final CanBeKitchenCategory other = new CanBeKitchenCategory();
  ...
  public void testHashCode() {
    assertThat(this.category.hashCode()).isEqualTo(new CanBeKitchenCategory().hashCode());
