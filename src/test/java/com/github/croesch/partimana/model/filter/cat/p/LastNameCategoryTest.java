...
public class LastNameCategoryTest {
  ...
  public void testGetShortDescription() {
    assertThat(category.getShortDescription()).isEqualTo(Text.FILTER_CAT_PARTICIPANT_LAST_NAME.text());
    assertThat(category.getShortDescription()).isEqualTo(Text.PARTICIPANT_LASTNAME.text());
  }
  ...
  public void testEquals() {
    assertThat(category).isEqualTo(new LastNameCategory());
  ...
  public void testHashCode() {
    assertThat(category.hashCode()).isEqualTo(new LastNameCategory().hashCode());
