...
public class SignedInCategoryTest {
  ...
  public void testGetShortDescription() {
    assertThat(category.getShortDescription()).isEqualTo(Text.FILTER_CAT_CAMP_PARTICIPANT_SIGNED_IN.text());
  }
  ...
  public void testIsMatchingFilter() {
    ...
    assertThat(category.isMatchingFilter(cp)).isFalse();

    final After after = new After();
    after.setFilterValue(new Date(7000000));
    category.setFilter(after);
    assertThat(category.isMatchingFilter(cp)).isTrue();
  ...
  public void testEquals() {
    assertThat(category).isEqualTo(new SignedInCategory());
  ...
  public void testHashCode() {
    assertThat(category.hashCode()).isEqualTo(new SignedInCategory().hashCode());
