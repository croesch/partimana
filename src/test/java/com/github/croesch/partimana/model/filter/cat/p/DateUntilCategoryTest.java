...
public class DateUntilCategoryTest {
  ...
  @org.junit.Before
  public void setUp() {
    category = new DateUntilCategory();
  }
  ...
  public void testGetShortDescription() {
    assertThat(category.getShortDescription()).isEqualTo(Text.FILTER_CAT_PARTICIPANT_DATE_UNTIL.text());
    assertThat(category.getShortDescription()).isEqualTo(Text.PARTICIPANT_DATE_UNTIL.text());
  }
  ...
  public void testEquals() {
    assertThat(category).isEqualTo(new DateUntilCategory());
  ...
  public void testHashCode() {
    assertThat(category.hashCode()).isEqualTo(new DateUntilCategory().hashCode());
