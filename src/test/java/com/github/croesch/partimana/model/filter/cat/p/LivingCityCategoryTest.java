...
public class LivingCityCategoryTest {
  ...
  @Before
  public void setUp() {
    category = new LivingCityCategory();
  }
  ...
  public void testGetShortDescription() {
    assertThat(category.getShortDescription()).isEqualTo(Text.FILTER_CAT_PARTICIPANT_LIVING_CITY.text());
    assertThat(category.getShortDescription())
        .isEqualTo(Text.CITY.text() + " (" + Text.PARTICIPANT_ADDRESS_LIVING.text() + ")");
  }
  ...
  public void testEquals() {
    assertThat(category).isEqualTo(new LivingCityCategory());
  ...
  public void testHashCode() {
    assertThat(category.hashCode()).isEqualTo(new LivingCityCategory().hashCode());
