...
public class LivingStreetCategoryTest {
  ...
  @Before
  public void setUp() {
    category = new LivingStreetCategory();
  }
  ...
  public void testGetShortDescription() {
    assertThat(category.getShortDescription()).isEqualTo(Text.FILTER_CAT_PARTICIPANT_LIVING_STREET.text());
    assertThat(category.getShortDescription())
        .isEqualTo(Text.STREET.text() + " (" + Text.PARTICIPANT_ADDRESS_LIVING.text() + ")");
  }
  ...
  public void testEquals() {
    assertThat(category).isEqualTo(new LivingStreetCategory());
  ...
  public void testHashCode() {
    assertThat(category.hashCode()).isEqualTo(new LivingStreetCategory().hashCode());
