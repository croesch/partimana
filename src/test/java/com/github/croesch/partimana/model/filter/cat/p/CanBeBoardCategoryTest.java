...
/**
 * Provides test cases for {@link CanBeBoardCategory}.
 * 
 * @author croesch
 * @since Date: Oct 27, 2012
 */
public class CanBeBoardCategoryTest {

  private CanBeBoardCategory category;

  @org.junit.Before
  public void setUp() {
    this.category = new CanBeBoardCategory();
  }
  ...
  public void testGetShortDescription() {
    assertThat(this.category.getShortDescription()).isEqualTo(Text.FILTER_CAT_PARTICIPANT_CAN_BE_BOARD.text());
    assertThat(this.category.getShortDescription()).isEqualTo(Text.PARTICIPANT_BOARD.text());
  }
  ...
  public void testEquals() {
    assertThat(this.category).isEqualTo(new CanBeBoardCategory());
    ...
    this.category.setFilter(new Equals<Boolean>());
    final CanBeBoardCategory other = new CanBeBoardCategory();
  ...
  public void testHashCode() {
    assertThat(this.category.hashCode()).isEqualTo(new CanBeBoardCategory().hashCode());
