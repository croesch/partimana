...
public class CommentCategoryTest {
  ...
  public void testGetShortDescription() {
    assertThat(category.getShortDescription()).isEqualTo(Text.FILTER_CAT_PARTICIPANT_COMMENT.text());
    assertThat(category.getShortDescription()).isEqualTo(Text.PARTICIPANT_COMMENT.text());
  }
  ...
  public void testEquals() {
    assertThat(category).isEqualTo(new CommentCategory());
  ...
  public void testHashCode() {
    assertThat(category.hashCode()).isEqualTo(new CommentCategory().hashCode());
