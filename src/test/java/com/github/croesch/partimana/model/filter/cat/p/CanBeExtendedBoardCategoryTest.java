...
/**
 * Provides test cases for {@link CanBeExtendedBoardCategory}.
 * 
 * @author croesch
 * @since Date: Oct 27, 2012
 */
public class CanBeExtendedBoardCategoryTest {

  private CanBeExtendedBoardCategory category;

  @org.junit.Before
  public void setUp() {
    this.category = new CanBeExtendedBoardCategory();
  }
  ...
  public void testGetShortDescription() {
    assertThat(this.category.getShortDescription()).isEqualTo(Text.FILTER_CAT_PARTICIPANT_CAN_BE_EXTENDED_BOARD.text());
    assertThat(this.category.getShortDescription()).isEqualTo(Text.PARTICIPANT_EXTENDED_BOARD.text());
  }
  ...
  public void testEquals() {
    assertThat(this.category).isEqualTo(new CanBeExtendedBoardCategory());
    ...
    this.category.setFilter(new Equals<Boolean>());
    final CanBeExtendedBoardCategory other = new CanBeExtendedBoardCategory();
  ...
  public void testHashCode() {
    assertThat(this.category.hashCode()).isEqualTo(new CanBeExtendedBoardCategory().hashCode());
