...
public class PhoneOfParentsCategoryTest {
  ...
  @Before
  public void setUp() {
    this.category = new PhoneOfParentsCategory();
  }
  ...
  public void testGetShortDescription() {
    assertThat(this.category.getShortDescription()).isEqualTo(Text.FILTER_CAT_PARTICIPANT_PHONE_OF_PARENTS.text());
    assertThat(this.category.getShortDescription()).isEqualTo(Text.PARTICIPANT_PHONE_OF_PARENTS.text());
  }
  ...
  public void testEquals() {
    assertThat(this.category).isEqualTo(new PhoneOfParentsCategory());
  ...
  public void testHashCode() {
    assertThat(this.category.hashCode()).isEqualTo(new PhoneOfParentsCategory().hashCode());
