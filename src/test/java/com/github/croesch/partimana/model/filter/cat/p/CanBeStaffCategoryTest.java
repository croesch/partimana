...
/**
 * Provides test cases for {@link CanBeStaffCategory}.
 * 
 * @author croesch
 * @since Date: Oct 27, 2012
 */
public class CanBeStaffCategoryTest {

  private CanBeStaffCategory category;

  @org.junit.Before
  public void setUp() {
    this.category = new CanBeStaffCategory();
  }
  ...
  public void testGetShortDescription() {
    assertThat(this.category.getShortDescription()).isEqualTo(Text.FILTER_CAT_PARTICIPANT_CAN_BE_STAFF.text());
    assertThat(this.category.getShortDescription()).isEqualTo(Text.PARTICIPANT_STAFF_GENERAL.text());
  }
  ...
  public void testEquals() {
    assertThat(this.category).isEqualTo(new CanBeStaffCategory());
    ...
    this.category.setFilter(new Equals<Boolean>());
    final CanBeStaffCategory other = new CanBeStaffCategory();
  ...
  public void testHashCode() {
    assertThat(this.category.hashCode()).isEqualTo(new CanBeStaffCategory().hashCode());
