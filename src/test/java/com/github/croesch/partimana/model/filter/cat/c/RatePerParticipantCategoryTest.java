...
public class RatePerParticipantCategoryTest {
  ...
  @Before
  public void setUp() {
    category = new RatePerParticipantCategory();
  }
  ...
  public void testGetShortDescription() {
    assertThat(category.getShortDescription()).isEqualTo(Text.FILTER_CAT_CAMP_RATE_PER_PART.text());
    assertThat(category.getShortDescription()).isEqualTo(Text.CAMP_RATE_PER_PARTICIPANT.text());
  }
  ...
  public void testEquals() {
    assertThat(category).isEqualTo(new RatePerParticipantCategory());
  ...
  public void testHashCode() {
    assertThat(category.hashCode()).isEqualTo(new RatePerParticipantCategory().hashCode());
