...
/**
 * Provides test cases for {@link CanBeMiscCategory}.
 * 
 * @author croesch
 * @since Date: Oct 27, 2012
 */
public class CanBeMiscCategoryTest {

  private CanBeMiscCategory category;

  @org.junit.Before
  public void setUp() {
    this.category = new CanBeMiscCategory();
  }
  ...
  public void testGetShortDescription() {
    assertThat(this.category.getShortDescription()).isEqualTo(Text.FILTER_CAT_PARTICIPANT_CAN_BE_MISC.text());
    assertThat(this.category.getShortDescription()).isEqualTo(Text.PARTICIPANT_MISC.text());
  }
  ...
  public void testEquals() {
    assertThat(this.category).isEqualTo(new CanBeMiscCategory());
    ...
    this.category.setFilter(new BooleanEquals());
    final CanBeMiscCategory other = new CanBeMiscCategory();
  ...
  public void testHashCode() {
    assertThat(this.category.hashCode()).isEqualTo(new CanBeMiscCategory().hashCode());
