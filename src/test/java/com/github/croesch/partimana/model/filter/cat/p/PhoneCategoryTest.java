...
public class PhoneCategoryTest {
  ...
  public void testGetShortDescription() {
    assertThat(category.getShortDescription()).isEqualTo(Text.FILTER_CAT_PARTICIPANT_PHONE.text());
    assertThat(category.getShortDescription()).isEqualTo(Text.PARTICIPANT_PHONE.text());
  }
  ...
  public void testEquals() {
    assertThat(category).isEqualTo(new PhoneCategory());
  ...
  public void testHashCode() {
    assertThat(category.hashCode()).isEqualTo(new PhoneCategory().hashCode());
