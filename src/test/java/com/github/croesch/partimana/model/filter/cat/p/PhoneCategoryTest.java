...
/**
 * Provides test cases for {@link PhoneCategory}.
 * 
 * @author croesch
 * @since Date: Oct 27, 2012
 */
public class PhoneCategoryTest {

  private PhoneCategory category;

  @Before
  public void setUp() {
    this.category = new PhoneCategory();
  }
  ...
  public void testGetShortDescription() {
    assertThat(this.category.getShortDescription()).isEqualTo(Text.FILTER_CAT_PARTICIPANT_PHONE.text());
    assertThat(this.category.getShortDescription()).isEqualTo(Text.PARTICIPANT_PHONE.text());
  }
  ...
  public void testEquals() {
    assertThat(this.category).isEqualTo(new PhoneCategory());
    ...
    final PhoneCategory other = new PhoneCategory();
  ...
  public void testHashCode() {
    assertThat(this.category.hashCode()).isEqualTo(new PhoneCategory().hashCode());
