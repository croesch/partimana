...
public class ForeNameCategoryTest {
  ...
  public void testGetShortDescription() {
    assertThat(category.getShortDescription()).isEqualTo(Text.FILTER_CAT_PARTICIPANT_FORE_NAME.text());
    assertThat(category.getShortDescription()).isEqualTo(Text.PARTICIPANT_FORENAME.text());
  }
