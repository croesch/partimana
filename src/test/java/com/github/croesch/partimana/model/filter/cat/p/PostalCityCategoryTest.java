...
public class PostalCityCategoryTest {
  ...
  @Before
  public void setUp() {
    category = new PostalCityCategory();
  }
  ...
  public void testGetShortDescription() {
    assertThat(category.getShortDescription()).isEqualTo(Text.FILTER_CAT_PARTICIPANT_POSTAL_CITY.text());
  ...
  public void testEquals() {
    assertThat(category).isEqualTo(new PostalCityCategory());
  ...
  public void testHashCode() {
    assertThat(category.hashCode()).isEqualTo(new PostalCityCategory().hashCode());
